...
### Day 1: CUDA基础 - 向量加法
- **学习目标**: 理解CUDA编程模型，编写第一个CUDA kernel
- **核心概念**: 线程块、网格、内存管理
- **实践项目**: 向量加法实现
- **文件**: `day1/README.md`, `day1/vector_add.cu`

### Day 2: 深入CUDA底层 - 手动加载PTX代码
- **学习目标**: 理解CUDA编译流程，掌握Driver API
- **核心概念**: PTX、CUBIN、CUDA上下文
- **实践项目**: 手动加载和执行PTX代码
...
### 内存层次
- **Global Memory**: 全局内存，容量大，延迟高
- **Shared Memory**: 共享内存，容量小，延迟低
- **Local Memory**: 局部内存，每个线程私有
- **Registers**: 寄存器，最快，容量最小
